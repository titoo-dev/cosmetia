import { ArrowRight, Search, Users, Globe, Zap, Shield } from "lucide-react";
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-[#166970] font-space-grotesk">Cosmetia</span>
            </div>
            <nav className="hidden md:flex items-center space-x-8">
              <Link href="/marketplace" className="text-gray-600 hover:text-[#166970] transition-colors">
                Marketplace
              </Link>
              <Link href="/suppliers" className="text-gray-600 hover:text-[#166970] transition-colors">
                Fournisseurs
              </Link>
              <Link href="/pricing" className="text-gray-600 hover:text-[#166970] transition-colors">
                Tarifs
              </Link>
              <Link href="/login" className="text-gray-600 hover:text-[#166970] transition-colors">
                Se connecter
              </Link>
      ...
      <section className="py-20 bg-[#F7F4EF]">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto font-plus-jakarta">
            Connectez-vous avec les meilleurs fournisseurs d'ingrédients cosmétiques. 
            Sourcez intelligemment avec l'aide de notre IA spécialisée.
          </p>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto font-plus-jakarta">
              Une plateforme moderne qui révolutionne le sourcing d'ingrédients cosmétiques
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-8 rounded-2xl bg-[#F7F4EF] hover:bg-gray-50 transition-colors">
              ...
              <p className="text-gray-600 font-plus-jakarta">
                Trouvez rapidement les ingrédients parfaits grâce à notre IA spécialisée dans la cosmétique
              </p>
            </div>
            ...
            <div className="text-center p-8 rounded-2xl bg-[#F7F4EF] hover:bg-gray-50 transition-colors">
              ...
              <p className="text-gray-600 font-plus-jakarta">
                Accédez à un réseau de fournisseurs vérifiés et certifiés pour une qualité garantie
              </p>
            </div>
            ...
            <div className="text-center p-8 rounded-2xl bg-[#F7F4EF] hover:bg-gray-50 transition-colors">
              ...
              <p className="text-gray-600 font-plus-jakarta">
                De la recherche à la commande, un processus optimisé pour gagner du temps
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8 font-plus-jakarta">
                Marques, laboratoires et fabricants de cosmétiques, accédez à une large base de fournisseurs 
                spécialisés dans les matières premières et les produits chimiques dédiés à l'industrie cosmétique.
              </p>
            ...
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8 font-plus-jakarta">
                Fournisseurs de matières premières et de produits chimiques spécialisés, 
                développez votre visibilité et touchez de nouveaux clients dans l'industrie cosmétique.
              </p>
              <ul className="space-y-4 mb-8">
                <li className="flex items-center gap-3 text-gray-700">
                  <div className="w-2 h-2 bg-[#166970] rounded-full"></div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-6 text-center">
          ...
          <h2 className="text-4xl font-bold text-black mb-6 font-space-grotesk">
            Notre assistance vous aide à sélectionner les ingrédients idéaux pour votre produit
          </h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto mb-8 font-plus-jakarta">
            Grâce à l'intelligence artificielle spécialisée en cosmétique, obtenez des recommandations 
            personnalisées pour vos formulations et découvrez les meilleurs fournisseurs.
          </p>
      ...
      <footer className="bg-[#166970] text-white py-16">
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center space-x-2 mb-6">
                <div className="w-8 h-8 bg-white rounded-lg flex items-center justify-center">
                  <span className="text-[#166970] font-bold text-sm">C</span>
                </div>
                <span className="text-xl font-bold font-space-grotesk">Cosmetia</span>
              </div>
              <p className="text-gray-300 font-plus-jakarta">
                La marketplace B2B de référence pour l'industrie cosmétique.
              </p>
            </div>
            
            <div>
              <h4 className="font-semibold mb-4 font-space-grotesk">S'inscrire</h4>
              <ul className="space-y-2 text-gray-300">
                <li><Link href="/register/buyer" className="hover:text-white transition-colors">Acheteurs</Link></li>
                <li><Link href="/register/supplier" className="hover:text-white transition-colors">Fournisseurs</Link></li>
              </ul>
            </div>
            
            <div>
              <h4 className="font-semibold mb-4 font-space-grotesk">Compagnie</h4>
              <ul className="space-y-2 text-gray-300">
            ...
            <div>
              <h4 className="font-semibold mb-4 font-space-grotesk">Support</h4>
              <ul className="space-y-2 text-gray-300">
