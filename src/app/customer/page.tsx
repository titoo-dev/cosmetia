      ...
      <div className="max-w-7xl mx-auto px-4 py-4">
        ...
        <div className="mb-8">
          <div className="flex space-x-8 mb-6">
            <button className="text-lg font-semibold text-green-600 border-b-2 border-green-600 pb-2">
              Produits
            </button>
            <button className="text-lg font-semibold text-gray-600 pb-2">
              Documents
            </button>
          </div>
          ...
          <div className="relative mb-6">
            <Input
              ...
              className="w-full pl-4 pr-12 py-3 text-lg border-2 border-gray-200 rounded-lg focus:border-green-500 focus:outline-none"
            />
              ...
              <CardContent className="p-0">
                ...
                {/* <div className="text-sm text-gray-600 space-y-1">
                  <div className="flex justify-between">
                    <span>Prix:</span>
                    <span className="font-medium">{product.pricePerQuantity}</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Livraison:</span>
