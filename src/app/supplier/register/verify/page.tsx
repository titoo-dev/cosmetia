...
import { verifySupplierEmailAction } from "@/actions/supplier/register/verify/verify-supplier-email-action";
...
export default function VerifyPage({
	...
	const [state, formAction, isPending] = useActionState(verifySupplierEmailAction, {
		error: "",
	});
	...
	useEffect(() => {
		if (state.success) {
			...
			router.push('/supplier/register/last-step');
		}
	}, [state.success]);
