...
export default function OrdersClient({ orders }: OrdersClientProps) {
  ...
  const exportToExcel = () => {
    ...
    const exportData = filteredOrders.map((order, index) => ({
      ...
      'Contact': order.customer.nameOfContact,
          ...
          <Table>
            <TableHeader>
              <TableRow className="border-b border-gray-200">
                ...
                <TableHead className="font-semibold text-gray-900 py-4 px-6">Client</TableHead>
                  ...
                  <TableRow key={order.id} className="border-b border-gray-100 hover:bg-gray-50">
                    ...
                    <TableCell className="py-4 px-6 text-gray-700">
                      <div>
                        ...
                        <div className="text-sm text-gray-500">{order.customer.nameOfContact}</div>
                      </div>
                    </TableCell>
                    <TableCell className="py-4 px-6 text-gray-700">
                      <div>
