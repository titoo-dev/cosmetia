...
interface ProviderRegisterLayoutProps {
    children: ReactNode;
}

export default function ProviderRegisterLayout({ children }: ProviderRegisterLayoutProps) {
    return (
        <div className="min-h-screen flex">
            <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
                <Image
                    src="/images/hero_image_register_supplier.png"
                    alt="Provider registration hero image"
                    fill
