...
import { registerProviderAction } from "@/actions/provider/register/register-provider-action";
import { useRouter } from "next/navigation";
import { toast } from "sonner";

export default function RegisterPage() {
    const router = useRouter();
    const [state, formAction, isPending] = useActionState(registerProviderAction, {
        errors: {},
        message: "",
    });
    ...
    useEffect(() => {
        ...
        if (state.success) {
            router.push("/provider/register/verify?email=" + state.data.email);
        }
