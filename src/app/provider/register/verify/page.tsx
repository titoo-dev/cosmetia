...
import { verifyProviderEmailAction } from "@/actions/provider/register/verify/verify-provider-email-action";
...
export default function VerifyPage({
	...
	const [state, formAction, isPending] = useActionState(verifyProviderEmailAction, {
		error: "",
	});
	...
	useEffect(() => {
		if (state.success) {
			...
			router.push('/provider/register/last-step');
		}
	}, [state.success]);
